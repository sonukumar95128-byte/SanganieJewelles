...
export function SectionBand({
  ...
  if (tone === "green") {
    return (
      <div className={"relative overflow-hidden bg-brand " + className}>
  ...
  return (
    <div className={"relative overflow-hidden bg-gradient-to-br from-[#f5efdf] via-ivory to-[#e2ece6] " + className}>
