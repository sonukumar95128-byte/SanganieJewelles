    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-beige p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-full bg-brand py-3 text-sm font-medium text-gold-light hover:bg-brand-secondary disabled:opacity-60 transition-colors mt-2"
            >
          ...
          <button
            ...
            className="mt-4 w-full flex items-center justify-center gap-2.5 rounded-full border border-beige py-2.5 text-sm text-ink/70 hover:border-gold hover:text-brand transition-colors"
          >
        ...
        <p className="text-center text-sm text-ink/50 mt-6">
          ...
          <Link href="/register" className="text-brand font-medium hover:text-gold transition-colors">
            Create account
          </Link>
        </p>
      </div>
